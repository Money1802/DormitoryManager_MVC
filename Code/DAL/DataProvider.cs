...
namespace DAL
{
    public class DataProvider
    {
        ...
        private static SqlConnection connection = new SqlConnection(new Connection().Connect());
        ...
        public static SqlDataAdapter GetSqlDataAdapterNguoiDung()
        {
            return  new SqlDataAdapter("select * from NGUOIDUNG", connection);
        }
